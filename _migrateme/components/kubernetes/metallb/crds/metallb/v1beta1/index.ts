...
export { ServiceBGPStatusArgs } from './serviceBGPStatus'
export type ServiceBGPStatus = import('./serviceBGPStatus').ServiceBGPStatus
export const ServiceBGPStatus: typeof import('./serviceBGPStatus').ServiceBGPStatus = null as any
utilities.lazyLoad(exports, ['ServiceBGPStatus'], () => require('./serviceBGPStatus'))

export { ServiceBGPStatusListArgs } from './serviceBGPStatusList'
export type ServiceBGPStatusList = import('./serviceBGPStatusList').ServiceBGPStatusList
export const ServiceBGPStatusList: typeof import('./serviceBGPStatusList').ServiceBGPStatusList =
    null as any
utilities.lazyLoad(exports, ['ServiceBGPStatusList'], () => require('./serviceBGPStatusList'))

export { ServiceBGPStatusPatchArgs } from './serviceBGPStatusPatch'
export type ServiceBGPStatusPatch = import('./serviceBGPStatusPatch').ServiceBGPStatusPatch
export const ServiceBGPStatusPatch: typeof import('./serviceBGPStatusPatch').ServiceBGPStatusPatch =
    null as any
utilities.lazyLoad(exports, ['ServiceBGPStatusPatch'], () => require('./serviceBGPStatusPatch'))
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case 'kubernetes:metallb.io/v1beta1:ServiceBGPStatus':
                return new ServiceBGPStatus(name, <any>undefined, { urn })
            case 'kubernetes:metallb.io/v1beta1:ServiceBGPStatusList':
                return new ServiceBGPStatusList(name, <any>undefined, { urn })
            case 'kubernetes:metallb.io/v1beta1:ServiceBGPStatusPatch':
                return new ServiceBGPStatusPatch(name, <any>undefined, { urn })
