...
export class Engine extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.EngineSpec>
    public readonly /*out*/ status!: pulumi.Output<outputs.longhorn.v1beta2.EngineStatus>
    ...
    constructor(name: string, args?: EngineArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: 'kubernetes:longhorn.io/v1beta1:Engine' }] }
