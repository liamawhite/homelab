...
export class BackupVolume extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.BackupVolumeSpec>
    public readonly /*out*/ status!: pulumi.Output<outputs.longhorn.v1beta2.BackupVolumeStatus>
    ...
    constructor(name: string, args?: BackupVolumeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: 'kubernetes:longhorn.io/v1beta1:BackupVolume' }] }
