...
export class RecurringJob extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:longhorn.io/v1beta1:RecurringJob'
    ...
    constructor(name: string, args?: RecurringJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: 'kubernetes:longhorn.io/v1beta2:RecurringJob' }] }
