...
export namespace tailscale {
    export namespace v1alpha1 {
        ...
        export interface ProxyClassSpecStaticEndpointsNodePort {
             ...
             */
            ports?: pulumi.Input<
                pulumi.Input<inputs.tailscale.v1alpha1.ProxyClassSpecStaticEndpointsNodePortPorts>[]
            >
            /**
        ...
        export interface ProxyClassSpecStaticEndpointsNodePortPatch {
             ...
             */
            ports?: pulumi.Input<
                pulumi.Input<inputs.tailscale.v1alpha1.ProxyClassSpecStaticEndpointsNodePortPortsPatch>[]
            >
            /**
             * A selector which will be used to select the node's that will have their `ExternalIP`'s advertised
             * by the ProxyGroup as Static Endpoints.
