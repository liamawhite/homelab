...
export class RaspberryPi extends pulumi.ComponentResource {
    ...
    constructor(name: string, args: RaspberryPiArgs, opts?: pulumi.ComponentResourceOptions) {
        ...
        const eepromApply = new remote.Command(
            `${name}-eeprom-apply`,
            {
                connection: args.connection,
        ...
        const cmdlineTxt = new remote.Command(
            `${name}-cmdline-txt-read`,
            {
                connection: args.connection,
        ...
        const cmdlineTxtWrite = new remote.Command(
            `${name}-cmdline-txt-write`,
            {
                connection: args.connection,
