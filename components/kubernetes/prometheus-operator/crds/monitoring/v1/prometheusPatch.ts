...
export class PrometheusPatch extends pulumi.CustomResource {
     ...
     */
    public readonly kind!: pulumi.Output<"Prometheus">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    public readonly metadata!: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    public readonly spec!: pulumi.Output<outputs.monitoring.v1.PrometheusSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.monitoring.v1.PrometheusStatusPatch>;
