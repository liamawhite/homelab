...
export class AlertmanagerPatch extends pulumi.CustomResource {
     ...
     */
    public readonly kind!: pulumi.Output<'Alertmanager'>
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    public readonly metadata!: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>
    public readonly spec!: pulumi.Output<outputs.monitoring.v1.AlertmanagerSpecPatch>
    public readonly /*out*/ status!: pulumi.Output<outputs.monitoring.v1.AlertmanagerStatusPatch>
