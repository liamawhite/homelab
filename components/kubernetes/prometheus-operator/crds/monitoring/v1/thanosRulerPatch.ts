...
export class ThanosRulerPatch extends pulumi.CustomResource {
     ...
     */
    public readonly kind!: pulumi.Output<'ThanosRuler'>
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    public readonly metadata!: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>
    public readonly spec!: pulumi.Output<outputs.monitoring.v1.ThanosRulerSpecPatch>
    public readonly /*out*/ status!: pulumi.Output<outputs.monitoring.v1.ThanosRulerStatusPatch>
