...
export namespace tailscale {
    export namespace v1alpha1 {
         ...
         */
        export function proxyClassSpecStatefulSetPodImagePullSecretsProvideDefaults(val: ProxyClassSpecStatefulSetPodImagePullSecrets): ProxyClassSpecStatefulSetPodImagePullSecrets {
            return {
                ...val,
                name: (val.name) ?? "",
            };
         ...
         */
        export function recorderSpecStatefulSetPodImagePullSecretsProvideDefaults(val: RecorderSpecStatefulSetPodImagePullSecrets): RecorderSpecStatefulSetPodImagePullSecrets {
            return {
                ...val,
                name: (val.name) ?? "",
            };
