...
export class ConnectorPatch extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ConnectorPatch {
    ...
    public /*out*/ readonly status!: pulumi.Output<outputs.tailscale.v1alpha1.ConnectorStatusPatch>;
