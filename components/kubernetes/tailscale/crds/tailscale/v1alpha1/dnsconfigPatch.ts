...
export class DNSConfigPatch extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): DNSConfigPatch {
     ...
     */
    public readonly kind!: pulumi.Output<"DNSConfig">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    public readonly metadata!: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    public readonly spec!: pulumi.Output<outputs.tailscale.v1alpha1.DNSConfigSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.tailscale.v1alpha1.DNSConfigStatusPatch>;
