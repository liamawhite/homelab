...
export class Recorder extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): Recorder {
    ...
    public /*out*/ readonly status!: pulumi.Output<outputs.tailscale.v1alpha1.RecorderStatus>;
