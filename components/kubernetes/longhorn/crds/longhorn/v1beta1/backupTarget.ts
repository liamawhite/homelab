...
export class BackupTarget extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:longhorn.io/v1beta1:BackupTarget';
    ...
    constructor(name: string, args?: BackupTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:longhorn.io/v1beta2:BackupTarget" }] };
