...
export class BackupTarget extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.BackupTargetSpec>
    public readonly /*out*/ status!: pulumi.Output<outputs.longhorn.v1beta2.BackupTargetStatus>
    ...
    constructor(name: string, args?: BackupTargetArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: 'kubernetes:longhorn.io/v1beta1:BackupTarget' }] }
