...
export class Node extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.NodeSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.NodeStatus>;
    ...
    constructor(name: string, args?: NodeArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:longhorn.io/v1beta1:Node" }] };
