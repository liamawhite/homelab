...
export class Replica extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.ReplicaSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.ReplicaStatus>;
    ...
    constructor(name: string, args?: ReplicaArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:longhorn.io/v1beta1:Replica" }] };
