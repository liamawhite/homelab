...
export class SupportBundle extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.SupportBundleSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.SupportBundleStatus>;
