...
/**
 * VolumeAttachmentList is a list of VolumeAttachment
 */
export class VolumeAttachmentList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:longhorn.io/v1beta2:VolumeAttachmentList'
     ...
     */
    public readonly items!: pulumi.Output<outputs.longhorn.v1beta2.VolumeAttachment[]>
    /**
...
export interface VolumeAttachmentListArgs {
     ...
     * List of volumeattachments. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
     */
    items: pulumi.Input<pulumi.Input<inputs.longhorn.v1beta2.VolumeAttachment>[]>
    /**
     * Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
     */
