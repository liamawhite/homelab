...
export class Backup extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.BackupSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.BackupStatus>;
    ...
    constructor(name: string, args?: BackupArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:longhorn.io/v1beta1:Backup" }] };
