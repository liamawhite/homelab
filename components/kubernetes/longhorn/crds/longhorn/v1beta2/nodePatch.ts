...
export class NodePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:longhorn.io/v1beta2:NodePatch';
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.NodeSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.NodeStatusPatch>;
    ...
    constructor(name: string, args?: NodePatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:longhorn.io/v1beta1:NodePatch" }] };
...
export interface NodePatchArgs {
    ...
    spec?: pulumi.Input<inputs.longhorn.v1beta2.NodeSpecPatch>;
}
