...
export class VolumeAttachment extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.VolumeAttachmentSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.VolumeAttachmentStatus>;
