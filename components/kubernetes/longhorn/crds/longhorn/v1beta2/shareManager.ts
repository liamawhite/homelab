...
export class ShareManager extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.ShareManagerSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.ShareManagerStatus>;
    ...
    constructor(name: string, args?: ShareManagerArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:longhorn.io/v1beta1:ShareManager" }] };
