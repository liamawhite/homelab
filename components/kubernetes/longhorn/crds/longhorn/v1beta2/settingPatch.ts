...
export class SettingPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:longhorn.io/v1beta2:SettingPatch'
    ...
    public readonly /*out*/ status!: pulumi.Output<outputs.longhorn.v1beta2.SettingStatusPatch>
    /**
    ...
    constructor(name: string, args?: SettingPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: 'kubernetes:longhorn.io/v1beta1:SettingPatch' }] }
