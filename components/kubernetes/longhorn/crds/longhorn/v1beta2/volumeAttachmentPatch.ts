...
export class VolumeAttachmentPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:longhorn.io/v1beta2:VolumeAttachmentPatch'
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.VolumeAttachmentSpecPatch>
    public readonly /*out*/ status!: pulumi.Output<outputs.longhorn.v1beta2.VolumeAttachmentStatusPatch>
...
export interface VolumeAttachmentPatchArgs {
    ...
    spec?: pulumi.Input<inputs.longhorn.v1beta2.VolumeAttachmentSpecPatch>
}
