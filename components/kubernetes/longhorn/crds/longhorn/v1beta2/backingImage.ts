...
export class BackingImage extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.BackingImageSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.BackingImageStatus>;
    ...
    constructor(name: string, args?: BackingImageArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:longhorn.io/v1beta1:BackingImage" }] };
