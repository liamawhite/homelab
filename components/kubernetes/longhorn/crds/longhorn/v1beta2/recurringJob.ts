...
export class RecurringJob extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.longhorn.v1beta2.RecurringJobSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.longhorn.v1beta2.RecurringJobStatus>;
    ...
    constructor(name: string, args?: RecurringJobArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:longhorn.io/v1beta1:RecurringJob" }] };
