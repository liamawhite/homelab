...
export class BFDProfilePatch extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): BFDProfilePatch {
        return new BFDProfilePatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:metallb.io/v1beta1:BFDProfilePatch';
     ...
     */
    constructor(name: string, args?: BFDProfilePatchArgs, opts?: pulumi.CustomResourceOptions) {
