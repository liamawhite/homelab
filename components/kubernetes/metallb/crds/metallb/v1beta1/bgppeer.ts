...
export class BGPPeer extends pulumi.CustomResource {
    ...
    public static readonly __pulumiType =
        'kubernetes:metallb.io/v1beta1:BGPPeer'
    ...
    public readonly spec!: pulumi.Output<outputs.metallb.v1beta1.BGPPeerSpec>
    /**
    ...
    constructor(
        ...
        const aliasOpts = {
            aliases: [{ type: 'kubernetes:metallb.io/v1beta2:BGPPeer' }],
        }
