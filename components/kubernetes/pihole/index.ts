...
export class Pihole extends pulumi.ComponentResource {
    ...
    constructor(name: string, args: PiholeArgs, opts: pulumi.ComponentResourceOptions & { provider: k8s.Provider }) {
        super("homelab:kubernetes:pihole", name, {}, opts)
        const localOpts = { ...opts, parent: this }

        const ns = new k8s.core.v1.Namespace(name, {
            metadata: { name: "pihole", labels: labels.namespace.enableAmbient },
        }, localOpts)
        this.namespace = ns.metadata.name

        this.password = new random.RandomPassword(name, {
            length: 16,
            special: false,
        }, { parent: this }).result
        ...
        const dns = new k8s.core.v1.Service(`${name}-dns`, {
            metadata: {
                name: "pihole-dns",
                namespace: this.namespace,
        ...
        const http = new k8s.core.v1.Service(`${name}-http`, {
            metadata: {
                name: "pihole-http",
                namespace: this.namespace,
                labels: deploy.metadata.labels,
        ...
        const cert = new Certificate(name, {
        ...
        const gw = new gateway.v1.Gateway(name, {
            metadata: {
                name: "pihole-webui",
                namespace: this.namespace,
        ...
        const httpRedirect = new gateway.v1.HTTPRoute(`${name}-redirect`, {
            metadata: {
        ...
        const httpRoute = new gateway.v1.HTTPRoute(name, {
            metadata: {
                name: "pihole-webui",
                namespace: this.namespace,
            },
        ...
        this.registerOutputs({ deploy, dns, http, httpRoute, httpRedirect, cert })
    }
}
