...
export const GatewayClassList: typeof import('./gatewayClassList').GatewayClassList =
    null as any
utilities.lazyLoad(exports, ['GatewayClassList'], () =>
    require('./gatewayClassList'),
)
...
export const GatewayClassPatch: typeof import('./gatewayClassPatch').GatewayClassPatch =
    null as any
utilities.lazyLoad(exports, ['GatewayClassPatch'], () =>
    require('./gatewayClassPatch'),
)

export { GatewayListArgs } from './gatewayList'
export type GatewayList = import('./gatewayList').GatewayList
export const GatewayList: typeof import('./gatewayList').GatewayList =
    null as any
...
export const GatewayPatch: typeof import('./gatewayPatch').GatewayPatch =
    null as any
...
export const HTTPRouteList: typeof import('./httprouteList').HTTPRouteList =
    null as any
...
export const HTTPRoutePatch: typeof import('./httproutePatch').HTTPRoutePatch =
    null as any
utilities.lazyLoad(exports, ['HTTPRoutePatch'], () =>
    require('./httproutePatch'),
)

export { ReferenceGrantArgs } from './referenceGrant'
export type ReferenceGrant = import('./referenceGrant').ReferenceGrant
export const ReferenceGrant: typeof import('./referenceGrant').ReferenceGrant =
    null as any
utilities.lazyLoad(exports, ['ReferenceGrant'], () =>
    require('./referenceGrant'),
)

export { ReferenceGrantListArgs } from './referenceGrantList'
export type ReferenceGrantList =
    import('./referenceGrantList').ReferenceGrantList
export const ReferenceGrantList: typeof import('./referenceGrantList').ReferenceGrantList =
    null as any
utilities.lazyLoad(exports, ['ReferenceGrantList'], () =>
    require('./referenceGrantList'),
)

export { ReferenceGrantPatchArgs } from './referenceGrantPatch'
export type ReferenceGrantPatch =
    import('./referenceGrantPatch').ReferenceGrantPatch
export const ReferenceGrantPatch: typeof import('./referenceGrantPatch').ReferenceGrantPatch =
    null as any
utilities.lazyLoad(exports, ['ReferenceGrantPatch'], () =>
    require('./referenceGrantPatch'),
)
