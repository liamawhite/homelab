...
export class GatewayClassPatch extends pulumi.CustomResource {
    ...
    public static get(
        ...
        return new GatewayClassPatch(name, undefined as any, {
            ...opts,
            id: id,
        })
    }
    ...
    public static readonly __pulumiType =
        'kubernetes:gateway.networking.k8s.io/v1beta1:GatewayClassPatch'
    ...
    public readonly /*out*/ status!: pulumi.Output<outputs.gateway.v1beta1.GatewayClassStatusPatch>
    ...
    constructor(
        ...
        const aliasOpts = {
            aliases: [
                {
                    type: 'kubernetes:gateway.networking.k8s.io/v1:GatewayClassPatch',
                },
            ],
        }
