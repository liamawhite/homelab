...
export class GatewayPatch extends pulumi.CustomResource {
    ...
    public static readonly __pulumiType =
        'kubernetes:gateway.networking.k8s.io/v1beta1:GatewayPatch'
    ...
    public readonly /*out*/ status!: pulumi.Output<outputs.gateway.v1beta1.GatewayStatusPatch>
    ...
    constructor(name: string, args?: GatewayPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = {
            aliases: [{ type: 'kubernetes:gateway.networking.k8s.io/v1:GatewayPatch' }],
        }
