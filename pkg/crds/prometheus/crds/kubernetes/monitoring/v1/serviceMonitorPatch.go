...
type ServiceMonitorPatch struct {
	...
	Status   ServiceMonitorStatusPatchPtrOutput `pulumi:"status"`
}
...
func (o ServiceMonitorPatchOutput) Status() ServiceMonitorStatusPatchPtrOutput {
	return o.ApplyT(func(v *ServiceMonitorPatch) ServiceMonitorStatusPatchPtrOutput { return v.Status }).(ServiceMonitorStatusPatchPtrOutput)
}
