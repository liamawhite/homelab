...
type ServiceMonitor struct {
	...
	Status   ServiceMonitorStatusPtrOutput `pulumi:"status"`
}
...
func (o ServiceMonitorOutput) Status() ServiceMonitorStatusPtrOutput {
	return o.ApplyT(func(v *ServiceMonitor) ServiceMonitorStatusPtrOutput { return v.Status }).(ServiceMonitorStatusPtrOutput)
}
