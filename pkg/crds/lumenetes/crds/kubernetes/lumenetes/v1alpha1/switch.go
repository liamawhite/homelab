...
func NewSwitch(ctx *pulumi.Context,
	...
	var resource Switch
	err := ctx.RegisterResource("kubernetes:lumenetes.io/v1alpha1:Switch", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSwitch(ctx *pulumi.Context,
	...
	var resource Switch
	err := ctx.ReadResource("kubernetes:lumenetes.io/v1alpha1:Switch", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
