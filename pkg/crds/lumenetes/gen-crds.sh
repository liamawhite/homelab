...
# applications/lumenetes/api/v1alpha1, via controller-gen
...
CONTROLLER_MODULE_DIR="$(cd "${SCRIPT_DIR}/../../../applications/lumenetes" && pwd)"
...
mv "${TMP_DIR}/lumenetes.io_lights.yaml" "${SCRIPT_DIR}/light-crd.yaml"
