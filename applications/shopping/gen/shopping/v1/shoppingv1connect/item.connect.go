...
const (
	...
	ItemServiceName = "shopping.v1.ItemService"
)
...
const (
	...
	ItemServiceListItemsProcedure = "/shopping.v1.ItemService/ListItems"
...
func NewItemServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ItemServiceClient {
	...
	itemServiceMethods := v1.File_shopping_v1_item_proto.Services().ByName("ItemService").Methods()
...
// CreateItem calls shopping.v1.ItemService.CreateItem.
...
// DeleteItem calls shopping.v1.ItemService.DeleteItem.
...
func (UnimplementedItemServiceHandler) ListItems(context.Context, *connect.Request[v1.ListItemsRequest]) (*connect.Response[v1.ListItemsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shopping.v1.ItemService.ListItems is not implemented"))
}
...
func (UnimplementedItemServiceHandler) CreateItem(context.Context, *connect.Request[v1.CreateItemRequest]) (*connect.Response[v1.CreateItemResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("shopping.v1.ItemService.CreateItem is not implemented"))
}
