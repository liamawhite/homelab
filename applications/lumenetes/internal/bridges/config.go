...
// the mounted Secret (pkg/components/lumenetescontroller) and this loader just
...
// lumenetes-controller (which reads them) must derive the same name from the
...
// Secret (see pkg/components/lumenetescontroller/component.go).
