...
// (pkg/crds/lumenetes/*.yaml, in the root module) are both generated from
// the markers below via controller-gen - see pkg/crds/lumenetes/gen-crds.sh.
// Run `go generate ./...` from the repo root (or `make gen`) after
// changing these types.
//
// +groupName=lumenetes.io
package v1alpha1
...
// LightStatus mirrors github.com/liamawhite/homelab/pkg/lumenetes/hue.Light,
